...
namespace JavaPackagePublishing.Controllers
{
    ...
    public class PublishController : ControllerBase
    {
        ...
        public async Task<IActionResult> Publish([FromForm] IFormFile data)
        {
            ...
            try
            {
                ...
                string mvnInstallationDirectory = _configuration["MAVEN_HOME"];
                string mvnExecutable = OperatingSystem.IsLinux() ? "mvn" : "mvn.cmd";
